...
\begin{figure}[H]
    ...
    \caption{Size comparison, from top to bottom: Fungus gnats, Leaf miner flies, Whiteflies. Green circles are the minimum and maximum contour area allowed. Green rectangles are the resultant rectangles for the areas, which are squares in this case. }
...
\multirow{5}{*}{Whiteflies} 
    ...
    & Max contour   & 1000 & \textit{same}  \\ \cline{2-4}
    & Max box size  & - &  95th percentile  \\ \cline{2-4}
    & Max box ratio & -  & 95th percentile \\ \cline{2-4}
    & Min value     & -  & 5th percentile \\ \hline
\end{tabular}
...
\begin{figure}[H]  % 
    \centering
    \includegraphics[width=1.0\textwidth]{images/figure14_mask_evaluation.jpg}  % Adjust width as needed
...
& 95th percentile box size & 41704 & 22340 & 3168 \\
& 95th percentile box ratio & 1.75 & 1.76 & 1.88  \\
& 5th percentile box value & - & - & 97 \\
\midrule
\multirow{3}{*}{Unlabeled Training Set} 
& 95th percentile box size & 42970  &  28530 & 3477 \\
& 95th percentile box ratio & 1.73 & 1.76 & 1.84 \\
& 5th percentile box value & - & - & 96 \\
\bottomrule
\end{tabular}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.32\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/figure17a_filter_tests_BRAIIM.jpg}
        % Optional subcaption if you like:
        % \subcaption{BRAIIM}
    \end{minipage}\hfill
    \begin{minipage}{0.32\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/figure17b_filter_tests_LIRIBO.jpg}
        % \subcaption{LIRIBO}
    \end{minipage}\hfill
    \begin{minipage}{0.32\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/figure17c_filter_tests_TRIAVA.jpg}
        % \subcaption{TRIAVA}
    \end{minipage}
...
\begin{table}[H]
    \centering
    \begin{tabular}{l c c c c}  % l = left-aligned, c = center-aligned
        \hline
        Class & \multicolumn{2}{c}{Labeled training set} & \multicolumn{2}{c}{Unlabeled training set} \\  % major columns
        \cline{2-5}  % horizontal line under sub-columns
        & Filter set 1 & Filter set 2 & Filter set 1 & Filter set 2 \\  % sub-columns
        \hline
        Fungus gnats & 3647 & 2800 & 3477 & 2691 \\
        Leaf miner flies & 3587 & 3297 & 3112 & 2714 \\
        Whiteflies & 2200 & 2141 & 5010 & 4916 \\
        Total & 9434 & 8238 & 11599 & 10321 \\
        \hline
    \end{tabular}
    \caption{Absolute number of rectangles created {\color{red} Why are the whitefly counts in the labeled training set not balanced?}}
