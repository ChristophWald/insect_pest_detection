...
final_mask_results = pd.read_csv("/user/christoph.wald/u15287/insect_pest_detection/3_2_image_processing_evaluation/data_labeled_training_set/metrics_final_mask.csv")
final_test_results = pd.read_csv("/user/christoph.wald/u15287/insect_pest_detection/3_2_image_processing_evaluation/data_labeled_training_set/metrics_final_test.csv")
