...
image_folder = "/user/christoph.wald/u15287/big-scratch/emptyYST_cropped/images"
dest_path = "/user/christoph.wald/u15287/big-scratch/emptyYST_cropped/tiles"
os.makedirs(dest_path, exist_ok=True)
...
for file in os.listdir(image_folder):
    if file.lower().endswith((".jpg", ".jpeg", ".png")):
        ...
        tile_and_save(
            ...
            tile_size=1280,
            stride=1080,
            save_only_with_labels=False  # save all tiles
        )
'''