...
#if False, set indidivual files below
automated_rotating = False
...
output_images_folder = "/user/christoph.wald/u15287/big-scratch/02_splitted_data/train_labeled/images_uncropped"
...
if automated_rotating:
    for file in image_files:
        ...
        # Label file path (same name but .txt)
...
#there might be an issue with BRAIIM_0029 - check manually
else:
        falsly_detected_images = ["BRAIIM_0042.jpg","BRAIIM_0635.jpg","BRAIIM_0666.jpg","BRAIIM_0668.jpg"]
