...
cropped_images_folder = "/user/christoph.wald/u15287/big-scratch/02_splitted_data/train_labeled/images_cropped"
...
with open("rectangles_simple_filter.txt", "w") as f:
