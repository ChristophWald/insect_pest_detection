...
#set correct output __path
#set correct conf_threshold (F1 + 0.1)
#load model
print("Loading model.")
model = YOLO('/user/christoph.wald/u15287/insect_pest_detection/2_5_self_training/runs/detect/train10/weights/best.pt')

#set in- & output path
print("Setting paths.")
base_input_path = "/user/christoph.wald/u15287/big-scratch/02_splitted_data/test_set"
#base_input_path = "/user/christoph.wald/u15287/big-scratch/02_splitted_data/train_labeled/supervised"
base_output_path = "/user/christoph.wald/u15287/insect_pest_detection/2_5_self_training/train10_test_test_set"
#base_output_path = "/user/christoph.wald/u15287/insect_pest_detection/2_5_self_training/test_training_set"
