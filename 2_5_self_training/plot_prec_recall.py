...
# Load the CSV file
file_path = '/user/christoph.wald/u15287/insect_pest_detection/2_5_self_training/runs/detect/train/results.csv'
...
plt.tight_layout()
save_path = '/user/christoph.wald/u15287/insect_pest_detection/2_5_self_training/runs/detect/train/results.jpg'
